...
export type SiraIndustryIndexQuery = { readonly siraIndustries: { readonly pageInfo: { readonly hasNextPage: boolean }, readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null, readonly name: string | null, readonly description: string | null, readonly siraLocale: { readonly code: string | null } | null, readonly digitalIndustry: { readonly eyebrow: string | null, readonly standfirst: string | null, readonly workflow: ReadonlyArray<{ readonly title: string | null } | null> | null, readonly stat: { readonly value: string | null, readonly label: string | null } | null } | null }> } | null };

export type DigitalAboutLinkFragment = { readonly title: string | null, readonly url: string | null, readonly target: string | null };

export type DigitalAboutMediaFragment = { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null };

export type SiraDigitalAboutQueryVariables = Exact<{
  uri: string | number;
  asPreview?: boolean | null | undefined;
}>;


export type SiraDigitalAboutQuery = { readonly page: { readonly databaseId: number, readonly uri: string | null, readonly title: string | null, readonly content: string | null, readonly modified: string | null, readonly siraLocale: { readonly code: string | null } | null, readonly pageIntro: { readonly eyebrow: string | null, readonly heading: string | null, readonly standfirst: string | null, readonly ctaLabel: string | null, readonly ctaHeading: string | null } | null, readonly digitalAbout: { readonly hero: { readonly eyebrow: string | null, readonly headingBefore: string | null, readonly headingHighlight: string | null, readonly headingAfter: string | null, readonly description: string | null, readonly primaryCta: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly secondaryCta: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly portrait: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null } | null, readonly stats: ReadonlyArray<{ readonly value: string | null, readonly label: string | null } | null> | null, readonly team: { readonly eyebrow: string | null, readonly heading: string | null, readonly standfirst: string | null } | null, readonly statement: { readonly ghostWord: string | null, readonly body: string | null, readonly quote: string | null, readonly attributionName: string | null, readonly attributionRole: string | null, readonly socials: ReadonlyArray<{ readonly network: string | null, readonly url: string | null } | null> | null } | null, readonly process: { readonly eyebrow: string | null, readonly heading: string | null, readonly standfirst: string | null, readonly steps: ReadonlyArray<{ readonly title: string | null, readonly body: string | null } | null> | null } | null } | null } | null, readonly siraLeadershipProfiles: { readonly pageInfo: { readonly hasNextPage: boolean }, readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null, readonly title: string | null, readonly excerpt: string | null, readonly siraLocale: { readonly code: string | null } | null, readonly personDetails: { readonly role: string | null, readonly linkedin: string | null } | null, readonly featuredImage: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null }> } | null };

export type SiraIndustryDetailQueryVariables = Exact<{
  id: string | number;
}>;


export type SiraIndustryDetailQuery = { readonly siraIndustry: { readonly databaseId: number, readonly slug: string | null, readonly name: string | null, readonly description: string | null, readonly siraLocale: { readonly code: string | null } | null, readonly digitalIndustry: { readonly eyebrow: string | null, readonly standfirst: string | null, readonly buildNote: string | null, readonly workflow: ReadonlyArray<{ readonly title: string | null, readonly detail: string | null } | null> | null, readonly stat: { readonly value: string | null, readonly label: string | null } | null, readonly build: ReadonlyArray<{ readonly item: string | null } | null> | null, readonly stack: ReadonlyArray<{ readonly item: string | null } | null> | null } | null } | null };
...
type EditorialFeedDesks_SiraBusinessUnitToAncestorsSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraBusinessUnitToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraCompanyToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraInsightToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraJobToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraNewsItemToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraPressReleaseToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraProjectToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialFeedDesks_SiraServiceToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

export type EditorialFeedDesksFragment =
  | EditorialFeedDesks_RootQueryToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraArticleToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraBusinessUnitToAncestorsSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraBusinessUnitToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraCompanyToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraInsightToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraJobToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraNewsItemToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraPressReleaseToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraProjectToSiraBusinessUnitConnection_Fragment
  | EditorialFeedDesks_SiraServiceToSiraBusinessUnitConnection_Fragment
;

export type EditorialFeedMediaFragment = { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } };
...
export type SiraEditorialFeedQuery = { readonly contentNodes: { readonly pageInfo: { readonly hasNextPage: boolean, readonly endCursor: string | null }, readonly nodes: ReadonlyArray<
      | { readonly __typename: 'GraphqlDocument', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
...
export type SiraBusinessUnitEditorialFeedQuery = { readonly siraBusinessUnit: { readonly contentNodes: { readonly pageInfo: { readonly hasNextPage: boolean, readonly endCursor: string | null }, readonly nodes: ReadonlyArray<
        ...
        | { readonly __typename: 'Page', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
        | { readonly __typename: 'Post', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
        | { readonly __typename: 'SiraArticle', readonly title: string | null, readonly excerpt: string | null, readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null, readonly featuredImage: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null }
        | { readonly __typename: 'SiraAward', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
        | { readonly __typename: 'SiraBoardMember', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
        | { readonly __typename: 'SiraCareerArea', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
        | { readonly __typename: 'SiraCaseStudy', readonly databaseId: number, readonly contentTypeName: string, readonly date: string | null, readonly modified: string | null, readonly uri: string | null, readonly isRestricted: boolean | null }
...
type EditorialSingleDesks_RootQueryToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraArticleToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraBusinessUnitToAncestorsSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraBusinessUnitToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraCompanyToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraInsightToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraJobToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraNewsItemToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraPressReleaseToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraProjectToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

type EditorialSingleDesks_SiraServiceToSiraBusinessUnitConnection_Fragment = { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> };

export type EditorialSingleDesksFragment =
  | EditorialSingleDesks_RootQueryToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraArticleToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraBusinessUnitToAncestorsSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraBusinessUnitToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraCompanyToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraInsightToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraJobToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraNewsItemToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraPressReleaseToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraProjectToSiraBusinessUnitConnection_Fragment
  | EditorialSingleDesks_SiraServiceToSiraBusinessUnitConnection_Fragment
;
...
export type SiraEditorialSingleQuery = { readonly nodeByUri:
    ...
    | { readonly __typename: 'GraphqlDocument', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null }
    | { readonly __typename: 'GraphqlDocumentGroup' }
    ...
    | { readonly __typename: 'Page', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null }
    ...
    | { readonly __typename: 'SiraArticle', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly title: string | null, readonly excerpt: string | null, readonly content: string | null, readonly siraLocale: { readonly code: string | null } | null, readonly featuredImage: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null, readonly siraBusinessUnits: { readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly slug: string | null }> } | null }
    ...
    | { readonly __typename: 'SiraIndustry', readonly siraLocale: { readonly code: string | null } | null }
    ...
    | { readonly __typename: 'SiraLeadershipProfile', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null }
    ...
    | { readonly __typename: 'SiraProduct', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null }
    | { readonly __typename: 'SiraProject', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null }
    ...
    | { readonly __typename: 'SiraService', readonly databaseId: number, readonly contentTypeName: string, readonly uri: string | null, readonly date: string | null, readonly modified: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null }
...
type HomepageEditorialNode_GraphqlDocument_Fragment = { readonly __typename: 'GraphqlDocument' };
...
export type HomepageEditorialNodeFragment =
  | HomepageEditorialNode_GraphqlDocument_Fragment
...
type HomepageDocumentNode_GraphqlDocument_Fragment = { readonly __typename: 'GraphqlDocument' };
...
export type HomepageDocumentNodeFragment =
  | HomepageDocumentNode_GraphqlDocument_Fragment
...
export type SiraHomepageQuery = { readonly page: { readonly databaseId: number, readonly uri: string | null, readonly title: string | null, readonly siraHomepage: { readonly variant: string | null } | null, readonly groupHomepage: { readonly hero: { readonly headingBefore: string | null, readonly headingHighlight: string | null, readonly headingAfter: string | null, readonly description: string | null, readonly primaryCta: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly secondaryCta: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly slides: ReadonlyArray<{ readonly titleOverride: string | null, readonly eyebrowOverride: string | null, readonly descriptionOverride: string | null, readonly locationOverride: string | null, readonly imageAltOverride: string | null, readonly imageOverride: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null, readonly mobileImageOverride: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null, readonly primaryCtaOverride: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly secondaryCtaOverride: { readonly title: string | null, readonly url: string | null, readonly target: string | null } | null, readonly businessUnit: { readonly nodes: ReadonlyArray<
            ...
            | { readonly __typename: 'GraphqlDocument' }
...
export type SiraProjectSingleQuery = { readonly siraProject: { readonly databaseId: number, readonly title: string | null, readonly uri: string | null, readonly excerpt: string | null, readonly date: string | null, readonly content: string | null, readonly isRestricted: boolean | null, readonly siraLocale: { readonly code: string | null } | null, readonly businessUnit: { readonly nodes: ReadonlyArray<{ readonly slug: string | null, readonly name: string | null }> } | null, readonly featuredImage: { readonly node: { readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null } } | null, readonly projectDetails: { readonly subtitle: string | null, readonly location: string | null, readonly status: string | null, readonly gallery: { readonly pageInfo: { readonly hasNextPage: boolean, readonly endCursor: string | null }, readonly nodes: ReadonlyArray<{ readonly databaseId: number, readonly sourceUrl: string | null, readonly altText: string | null, readonly isRestricted: boolean | null, readonly mediaDetails: { readonly width: number | null, readonly height: number | null } | null }> } | null, readonly statistics: ReadonlyArray<{ readonly label: string | null, readonly value: string | null } | null> | null, readonly relatedCompany: { readonly pageInfo: { readonly hasNextPage: boolean, readonly endCursor: string | null }, readonly nodes: ReadonlyArray<
          | { readonly __typename: 'GraphqlDocument', readonly databaseId: number, readonly isRestricted: boolean | null }
...
export const DigitalAboutLinkFragmentDoc = new TypedDocumentString(`
    fragment DigitalAboutLink on AcfLink {
  title
  url
  target
}
    `, {"fragmentName":"DigitalAboutLink"}) as unknown as TypedDocumentString<DigitalAboutLinkFragment, unknown>;
export const DigitalAboutMediaFragmentDoc = new TypedDocumentString(`
  ...
  mediaDetails {
    ...
    `, {"fragmentName":"DigitalAboutMedia"}) as unknown as TypedDocumentString<DigitalAboutMediaFragment, unknown>;
export const EditorialFeedDesksFragmentDoc = new TypedDocumentString(`
  ...
  nodes {
    ...
    `, {"fragmentName":"EditorialFeedDesks"}) as unknown as TypedDocumentString<EditorialFeedDesksFragment, unknown>;
export const EditorialFeedMediaFragmentDoc = new TypedDocumentString(`
  ...
  node {
    ...
    `, {"fragmentName":"EditorialFeedMedia"}) as unknown as TypedDocumentString<EditorialFeedMediaFragment, unknown>;
...
export const EditorialSingleDesksFragmentDoc = new TypedDocumentString(`
    fragment EditorialSingleDesks on SiraBusinessUnitConnection {
  nodes {
    databaseId
    slug
  }
}
    `, {"fragmentName":"EditorialSingleDesks"}) as unknown as TypedDocumentString<EditorialSingleDesksFragment, unknown>;
...
export const SiraDigitalAboutDocument = new TypedDocumentString(`
  ...
  siraLeadershipProfiles(
    first: 24
    where: {status: PUBLISH, orderby: [{field: MENU_ORDER, order: ASC}, {field: TITLE, order: ASC}]}
  ) {
    pageInfo {
      hasNextPage
    }
...
}`) as unknown as TypedDocumentString<SiraDigitalAboutQuery, SiraDigitalAboutQueryVariables>;
export const SiraIndustryDetailDocument = new TypedDocumentString(`
  ...
  siraIndustry(id: $id, idType: SLUG) {
    ...
    `) as unknown as TypedDocumentString<SiraIndustryDetailQuery, SiraIndustryDetailQueryVariables>;
